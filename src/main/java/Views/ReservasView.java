...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/src/resources/imagenes/aH-40px.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/src/resources/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/src/resources/imagenes/reservas-img-3.png")));
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/src/resources/imagenes/icon-reservas.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/src/resources/imagenes/icon-reservas.png")));
	...
	private void guardarReservas(){
		if(txtFechaEntrada.getDate() != null  && txtFechaSalida.getDate() != null && !txtValor.equals("")
			...
			Reservas reservas = new Reservas(dataE, dataS, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
			reservasControl.guardar(reservas);
	...
	//metodo para cuando se actualizen las fechas de la tablas se limpie el valor
