...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/src/resources/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/src/resources/imagenes/icon-reservas.png")));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/src/resources/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/src/resources/imagenes/Ha-100px.png")));
	 ...
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		private void guardarHuespedes(){
			if (txtFechaN.getDate() !=null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
				...
				Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(),fechaN, txtNacionalidad.getSelectedItem().toString(),
				...
				JOptionPane.showMessageDialog(this, "Rellenas todo los campos");
			}
		}
